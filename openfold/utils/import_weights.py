...
def generate_translation_dict_evoformer(model, version):
     #######################
    # Some templates
    #######################
...
def import_evoformer_weights_(model, npz_path, version="model_1"):
    data = np.load(npz_path)

    translations = generate_translation_dict_evoformer(model, version)
